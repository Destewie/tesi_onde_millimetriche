...
~/Experiments/csi300_v3.sh /tmp/csi_measurements_fede.txt 'Mikrotik11' '\x08\x55\x31\x9B\x0A\x1D'
echo "csi measures done!"

echo "Starting with the ftm measures..."
~/Experiments/ftm10.sh /tmp/ftm_measurements_fede.txt 'Mikrotik11' '\x08\x55\x31\x9B\x0A\x1D'
